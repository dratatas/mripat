...
@section('content')
    <div class="row justify-content-center">
        <div class="col-12 col-md-8 col-lg-4">
            ...
            <img src="{{url('/images/logomripat.png')}}" class="img-responsive rounded mx-auto d-block" style="width: 20vw;">
            <!-- <img src="images/logomripat.png" class="img-responsive" style="width: 5vw; min-width: 25px;"> -->
            <div class="card">
                <div class="card-body">
