<header class="{{ config('backpack.base.header_class') }}">
  ...
  <a class="navbar-brand" href="{{ url(config('backpack.base.home_link')) }}" title="{{ config('backpack.base.project_name') }}">{!! config('backpack.base.project_logo') !!}</a>
  ...
  @include(backpack_view('inc.frontend_menu'))
</header>
