...
return [
    ...
    */
    ...
    'project_logo'   => '<style="width: 5vw; min-width: 25px;">&nbsp;<span style="font-size:15px; font-family:"Helvetica Neue","Lucida Grande", Arial;font-stretch: condensed;"><b>Kanwil DJPb </b> Prov.Kalbar</span>',
    'project_logo'   => '<img src="{{ asset(images/logokemenkeu.png) }}" class="img-responsive"><br><small><b>lolololol DJPb </b> Prov.Kalbar</small>',
    // 'project_logo'   => '<style="width: 5vw; min-width: 25px;">&nbsp;<span style="font-size:15px; font-family:"Helvetica Neue","Lucida Grande", Arial;font-stretch: condensed;"><b>Kanwil DJPb </b> Prov.Kalbar</span>',
    ...
    'developer_name' => 'Stephanie',

    // Developer website. Link in footer. Type false if you want to hide it.
    'developer_link' => 'mailto:d1041191045@student.untan.ac.id',
